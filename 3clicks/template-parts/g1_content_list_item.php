...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'g1-grid' ); ?>>
    <div class="g1-column g1-two-third">
        <?php
            if ( $g1_elems['featured-media'] ) {
                g1_render_entry_featured_media(
                    $g1_collection->get_image_size(),
                    $g1_collection->get_lightbox_group(),
                    $g1_collection->get_force_placeholder()
                );
            }
        ?>
    </div>
