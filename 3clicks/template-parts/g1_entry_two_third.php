...
<article itemscope itemtype="<?php g1_render_entry_itemtype(); ?>" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <header class="entry-header">
        ...
        <div class="g1-hgroup">
            <?php if ( $g1_title ): ?>
                <h1 class="entry-title" itemprop="headline"><?php echo $g1_title; ?></h1>
            <?php endif; ?>
            <?php if ( $g1_subtitle ): ?>
        ...
        <p class="g1-meta entry-meta">
            <?php
                ...
                if ( $g1_elems['author'] )          { g1_render_entry_author( array( 'use_microdata' => true ) ); }
    ...
    <?php g1_render_missing_metadata(); ?>
